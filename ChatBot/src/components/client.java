...
public class client extends JFrame {
	...
	void run() {
		...
		{ 
		String s; 
		s = "Login and Connect. Connect to localhost then input your username "+"\n"; 
		...
		{ 
		JOptionPane.showMessageDialog (this, "No server is found", "ERROR", JOptionPane.ERROR_MESSAGE); 
